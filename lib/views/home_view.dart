  ...
  Widget build(BuildContext context) {
    ...
    body: 
     ...
     Card(
        ...
        ListTile(
          leading:  IconButton(onPressed: (){}, icon: Icon(Icons.check_circle_outline_outlined), color: Colors.black,),
             title: Text("Go braiding.", style:TextStyle(fontSize:15,fontWeight: FontWeight.w800, color: Colors.blue),
             
        ),
        subtitle: Text("Go with Maadwoa ", style:TextStyle(fontSize:12,fontWeight: FontWeight.w500, color: Colors.black),
        ),
        ),
          ),
            Card(
        ...
        ListTile(
          leading:  IconButton(onPressed: (){}, icon: Icon(Icons.check_circle_outline_outlined), color: Colors.black,),
             title: Text("Go to a wedding in Tamso.", style:TextStyle(fontSize:15,fontWeight: FontWeight.w800, color: Colors.blue),
             
        ),
        subtitle: Text("Catch the flower", style:TextStyle(fontSize:12,fontWeight: FontWeight.w500, color: Colors.black),
        ),
        ),
          ),
            Card(
        ...
        ListTile(
          leading:  IconButton(onPressed: (){}, icon: Icon(Icons.check_circle_outline_outlined), color: Colors.black,),
             title: Text("Join thye gym", style:TextStyle(fontSize:15,fontWeight: FontWeight.w800, color: Colors.blue),
             
        ),
        subtitle: Text("Go with Sammy and Ebenezer ", style:TextStyle(fontSize:12,fontWeight: FontWeight.w500, color: Colors.black),
        ),
        ),
          ),
           Card(
